...
//   // New function to fetch calendar data
...
//       // Format month as YYYY-MM (e.g., 2025-06 for June 2025)
//       const formattedMonth = `${year}-${String(month + 1).padStart(2, "0")}`;
//       const apiUrl = `${backendUrl}/api/calendar/?date=${formattedMonth}`;
...
//       if (!data.year || !data.month || !Array.isArray(data.has_masterclass)) {
...
//       setError(`Ошибка загрузки данных календаря: ${err.message}`);
//     } finally {
...
//       setSelectedMasterclassId(masterclassId);
//     } else {
//       // If no masterclassId, start with date selection and load calendar and masterclasses
//       setCurrentStep("date");
//       fetchMasterclasses();
//       fetchCalendarData(currentYear, currentMonth); // Fetch calendar data for current month
//     }
//   }, [masterclassId, currentYear, currentMonth]);
...
//           isCurrentMonth: date.getMonth() === month,
//           hasMasterclass:
//             calendarData?.has_masterclass?.includes(date.getDate()) || false,
//         });
//         currentDate.setDate(currentDate.getDate() + 1);
//       }
//       calendar.push(weekDays);
...
//       // When in date selection step, use calendarData.days
//       const dayData = calendarData.days.find(
//         (day) => day.day === date.getDate()
//       );
//       if (dayData) {
//         return dayData.masterclasses.map((mc) => ({
//           id: mc.id,
//           start: date.toISOString(), // Note: API may need to provide slot times
//           free_places: mc.free_places || 1, // Adjust based on actual API response
//         }));
//       }
//       return [];
//     } else {
//       // Fallback: check all masterclasses (less efficient)
//       const allSlots = [];
//       masterclasses.forEach((mc) => {
//         if (mc.slots) {
//           mc.slots.forEach((slot) => {
...
//       setSelectedTime(null);
//     }
//     fetchCalendarData(newYear, newMonth); // Fetch calendar data for new month
//   };
...
//             } else {
//               fetchMasterclasses();
//               fetchCalendarData(currentYear, currentMonth); // Retry calendar data
//             }
//           }}
//           className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600"
//         >
...
//           {calendarLoading ? (
//             <div className="flex items-center justify-center h-64">
//               <div className="text-lg text-gray-600">Загрузка календаря...</div>
//             </div>
//           ) : (
//             <div className="border-2 border-blue-300 rounded-2xl p-6 bg-white">
//               {/* Month Navigation */}
