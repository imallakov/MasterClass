...
//   //     // Fixed image upload section in handleSubmit
//   //     if (selectedFile) {
...
//   //           {
//   //             method: "POST",
//   //             // Don't set headers manually for FormData - let makeAuthenticatedRequest handle it
...
//   //           imageUrl = uploadResult.url || uploadResult.image_url || imageUrl;
//   //         } else {
//   //           console.warn("Image upload failed, using temporary URL");
//   //         }
//   //       } catch (uploadError) {
...
//   //     console.log("Creating masterclass with data:", masterclassData);
...
//   //       const errorData = await masterclassResponse.json();
//   //       console.error("Masterclass creation error:", errorData);
//   //       throw new Error(
//   //         errorData.detail ||
//   //           errorData.message ||
//   //           `Ошибка при создании мастер-класса (${masterclassResponse.status})`
//   //       );
//   //     }
...
//   //     // Step 3: Create slot for masterclass
//   //     // Example: create slot for tomorrow from 10:00 to 12:00
...
//       // Step 2: Create slot for masterclass
//       const tomorrow = new Date();
//       tomorrow.setDate(tomorrow.getDate() + 1);
//       tomorrow.setHours(10, 0, 0, 0);
